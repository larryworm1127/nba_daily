...
urlpatterns += [
    ...
    path('players/<int:pk>/<str:season>', views.PlayerGamesDetailView.as_view(), name='player_games')
]
...
urlpatterns += [
    ...
    path('teams/<int:pk>/<str:season>', views.TeamGamesDetailView.as_view(), name='team_games'),
